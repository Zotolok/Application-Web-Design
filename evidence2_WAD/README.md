...
With the previous instructions, you will be able to open this project and test it (download all the files in "evidence2_WAD" or just the ones you need for make your own testings).
